...
4. Quit
2
Enter a key to delete: 23384
Key 23384 removed from the table.
Choose an operation:
1. Insert
2. Delete
3. Search
4. Quit
3
Enter a key to search: 203994
Key 203994 not found in the table.
Choose an operation:
1. Insert
2. Delete
3. Search
